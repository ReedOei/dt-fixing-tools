...
testFile=$(grep "$fullTestName" /home/awshi2/$slug/test-to-file.csv | head -1 | cut -d"," -f2)
...
do 
  ...
  /home/awshi2/dt-fixing-tools/scripts/run_experiment.sh $slug-$shortSha ${rounds} ${timeout} "run_random_class_method.sh" ""
