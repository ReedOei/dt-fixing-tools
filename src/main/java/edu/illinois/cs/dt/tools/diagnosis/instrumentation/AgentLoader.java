...
/**
 * This class is copied from STARTS, which is in turn duplicated from Ekstazi, with minor changes.
 */
public final class AgentLoader {
    ...
    public static boolean loadDynamicAgent() {
        try {
            ...
            URL agentJarURL = AgentLoader.class.getResource("JavaAgent.class");
